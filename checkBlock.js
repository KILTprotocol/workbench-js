...
// const { typesBundle, types21 } = require('@kiltprotocol/type-definitions')
      ...
      types: [
        {
          ...
          types: {
            ...
            DidKeyAgreementKeys:
              'BoundedBTreeSet<KeyIdOf, MaxTotalKeyAgreementKeys>',
...
async function setup() {
  ...
  const hash = await api.rpc.chain.getBlockHash(156)
  ...
  console.log(JSON.stringify(allRecords.toHuman(), null, 2))
